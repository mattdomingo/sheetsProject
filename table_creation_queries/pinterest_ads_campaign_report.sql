-- Pinterest Ads Campaign Report table creation query
-- Contains daily performance metrics at the campaign level
CREATE OR REPLACE TABLE `sheets_base_schema.pinterest_ads__campaign_report` (
...
OPTIONS (description = 'Daily performance metrics at the Pinterest Ads campaign level'); 