-- Pinterest Ads Pin Promotion Report table creation query
-- Contains daily performance metrics at the pin promotion level
CREATE OR REPLACE TABLE `sheets_base_schema.pinterest_ads__pin_promotion_report` (
  ...
  `pin_name` STRING OPTIONS(description = 'Name of the pin.'),
  `pin_status` STRING OPTIONS(description = 'Status of the pin.'),
...
OPTIONS (description = 'Daily performance metrics at the Pinterest Ads pin promotion level'); 