...
TRUNCATE TABLE `sheets_base_schema.amazon_selling_partner__orders`;

-- Insert data from the source table into the target table
INSERT INTO `sheets_base_schema.amazon_selling_partner__orders` (
  `source_relation`,
  `amazon_order_id`,
  `marketplace_id`,
  `replaced_order_id`,
...
SELECT
  ...
  `count_promotions_used`
FROM
  `amazon_selling_partner_amazon_selling_partner.amazon_selling_partner__orders`;
